...
uniCircleClass.prototype.setInterval(function() {
           flash = !flash;
           if (!moving) {
        ...
        uniCircleClass.prototype.drawCircle = function(ctx, angle);
  
        uniCircleClass.prototype.start() {
          moving = true;
          drawCircle(ctx, angle);
        }
  
        uniCircleClass.prototype.stop = function() {
          moving = false;
          drawCircle(ctx, angle);
        }
